...
def main(args):
    ...
    filename_pattern = f'{{epoch}}-{{step}}_salience_combined_{model_id}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prediction_path', default='abstractive/ML-MD/predictions/', help='path to save prediction outputs') 
