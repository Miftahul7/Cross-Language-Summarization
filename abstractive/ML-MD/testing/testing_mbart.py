...
class Dataset1(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Default to English if unsupported lang code
        ...
        # --- Tokenization ---
        if self.is_mt5:
            # Use language prompts in mT5
            input_encoding = self.tokenizer(
                src_lang + ' ' + input_text + ' </s>',
                return_tensors='pt',
            ...
            # Use lang codes as tokenizer config in mBART
...
class Summarizer(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        return {'pred_text': pred_text, 'ref_text': ref_text}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prediction_path', default='preds_combined.txt', help='path to save prediction file')
    ...
    trainer = pl.Trainer(accelerator="gpu", devices=1, precision= "16-mixed", logger=logger)
