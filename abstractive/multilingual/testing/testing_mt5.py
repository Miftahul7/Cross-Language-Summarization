...
class Summarizer(pl.LightningModule):
    ...
    def on_test_epoch_end(self):
        ...
        save_path = f'abstractive/multilingual/predictions/{model_nm}_predictions/lang_wise_{domain}_{model_nm}.csv'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prediction_path', default='preds_films.txt', help='path to save prediction file')
    ...
    if 'mt5' in model_name:
        ...
        is_mt5 = 0
    print('-----------------------------------------------------------------------------------------------------------')
    train_path = 'XWikiRef/mL_split/' + domain + '/' + domain + '_train.json'
    val_path = 'XWikiRef/mL_split/' + domain + '/' + domain + '_val.json'
    test_path = 'XWikiRef/mL_split/' + domain + '/' + domain + '_test.json'
